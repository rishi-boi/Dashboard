...
const ThemeSettings = () => {
  ...
  return (
    <div className="bg-have-transparent  w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:bg-secondary-dark-bg w-400">
        <div className="flex justify-between items-center p-4 ml-4">
          ...
          <button
            ...
            className='text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray dark:hover:bg-gray-700'
